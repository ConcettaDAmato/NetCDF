	...
	public void read() throws IOException {
		...
		if (step == 0) {
			...
			try {
				...
				ArrayDouble.D1 dataArrayKs = (ArrayDouble.D1) dataPar1SWRC.read(null, sizeParameter);
				ArrayDouble.D1 dataArrayAlphaSS = (ArrayDouble.D1) dataKs.read(null, sizeParameter);
				ArrayDouble.D1 dataArrayBetaSS = (ArrayDouble.D1) dataAlphaSS.read(null, sizeParameter);
				ArrayDouble.D1 dataArrayPar1SWRC = (ArrayDouble.D1) dataBetaSS.read(null, sizeParameter);
