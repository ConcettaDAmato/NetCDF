 ...
 */
package it.geoframe.blogspot.netcdf.examples;
...
public class Sfc_pres_temp_rd {
  ...
  public static void main(String args[]) throws Exception {
    ...
    try {
      ...
      // them and check them.
      /*
       * Error in the file download: switched degrees_east with degrees_north
       */
      if (!latVar.findAttributeIgnoreCase("units").getStringValue().equalsIgnoreCase("degrees_east"))
        System.err.println("ERROR reading variable latitude units");

      if (!lonVar.findAttributeIgnoreCase("units").getStringValue().equalsIgnoreCase("degrees_north"))
