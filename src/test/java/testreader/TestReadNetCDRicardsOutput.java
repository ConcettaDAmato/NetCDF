...
import monodimensionalProblemTimeDependent.ReadNetCDFRichardsOutput;
 ...
 */
public class TestReadNetCDRicardsOutput {

	@Test
	public void Test() throws Exception {
		
		ReadNetCDFRichardsOutput read = new ReadNetCDFRichardsOutput();
